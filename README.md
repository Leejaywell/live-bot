...
- [x] 结构化保存完整直播事件：弹幕、礼物、大航海、进场/关注/分享、命令事件，字段包含房间号、UID、昵称、粉丝牌、舰长等级、时间。
- [x] 增加直播数据概览：本场弹幕数、进场人数、关注数、礼物金额、大航海人数、最高/平均人气。
- [x] 增加用户详情查询：最近弹幕、累计弹幕、最近礼物、累计礼物、进场次数、粉丝牌信息。
- [ ] 完善 PK 能力：识别对面直播间、拉取对手信息、最佳助攻、PK 进度、PK 历史和连胜提示。
  - [x] 已完成基础闭环：识别对面直播间、保存 PK 历史、记录进度事件、按本场查询对手与胜场。
- [ ] 增加新人发言识别、特别关心高亮、专属昵称、永久黑名单。
  - [x] 已完成基础观众规则：新人发言识别、专属昵称、永久黑名单。
- [ ] 增加弹幕过滤器：敏感词、重复刷屏、疑似机器人、小号风险、条件禁言。
  - [x] 已完成基础过滤：敏感词、重复刷屏、风险弹幕不触发自动回复。
- [x] 增加礼物别名、指定礼物答谢模板、礼物总结答谢。
