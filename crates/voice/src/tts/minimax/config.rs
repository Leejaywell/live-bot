...
impl Default for MiniMaxConfig {
    fn default() -> Self {
        Self {
            ...
            model: env_str("MINIMAX_TTS_MODEL", "speech-2.6-turbo"),
            default_voice_id: Some(env_str(
                "MINIMAX_TTS_DEFAULT_VOICE_ID",
                "zh_female_wanwanxiaohe_moon_bigtts",
            )),
            connect_timeout_secs: env_u64("MINIMAX_TTS_CONNECT_TIMEOUT_SECS", 10),
            timeout_secs: env_u64("MINIMAX_TTS_TIMEOUT_SECS", 30),
        }
    }
}
...
impl MiniMaxConfig {
    ...
    pub fn default_ws_url() -> String {
        env_str("MINIMAX_TTS_WS_URL", "wss://api.minimaxi.com/ws/v1/t2a_v2")
    }

    /// 默认 HTTP URL
    pub fn default_http_url() -> String {
        env_str("MINIMAX_TTS_HTTP_URL", "https://api.minimaxi.com/v1/t2a_v2")
    }
